    ...
    <section class="bg-white rounded-xl shadow p-6">
      <div class="flex items-center justify-between mb-4">
        ...
        <div class="flex items-center gap-4">
          <button id="importOdataBtn" class="text-sm text-white bg-sky-600 hover:bg-sky-700 px-3 py-1.5 rounded-lg font-semibold" data-key="shg_profiling_form" title="Pull the shg_profiling_form master sheet from its external OData feed (paginated import)"><i class="fas fa-cloud-arrow-down mr-1"></i>Import shg_profiling_form</button>
      ...
      <div id="importOdataStatus" class="hidden mb-3 text-sm"></div>
